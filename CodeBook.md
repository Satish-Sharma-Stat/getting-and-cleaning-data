# codes up to # 5th task which i used (Rest codes are from the original data file UCI HAR Dataset)
#1st task
...
# code for activities (As given in the original data file UCI HAR Dataset)
1 WALKING
2 WALKING_UPSTAIRS
...
5 STANDING
6 LAYING
# code for features (As given in features_info in the original data file UCI HAR Dataset)
